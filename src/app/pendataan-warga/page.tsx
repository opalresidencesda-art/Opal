...
export default function PendataanWargaPage() {
  return <div className="mx-auto max-w-[1040px] px-5 py-10 sm:px-8 lg:px-10 lg:py-16">
    <section className="border-b border-line pb-9">
      <p className="text-sm font-semibold text-brand">Pendataan warga</p>
      <h1 className="mt-3 max-w-3xl text-balance text-4xl font-bold tracking-[-0.065em] text-ink sm:text-5xl lg:text-6xl">Data satu rumah, diperlakukan dengan semestinya.</h1>
    ...
    <section className="py-10 sm:py-12"><div className="rounded-[16px] border border-line bg-surface-raised p-5 sm:p-8"><ResidentDataForm /></div></section>
  </div>;
}
