  ...
  return (
    <main className="mx-auto flex min-h-[58vh] max-w-[1440px] items-center px-5 py-16 sm:px-8 lg:px-10">
      <div className="max-w-xl">
        ...
        <Link href="/" className="mt-7 inline-flex min-h-12 items-center gap-2 rounded-full bg-ink px-5 text-sm font-bold text-ink-inverse transition hover:-translate-y-0.5 hover:bg-brand active:translate-y-0"><ArrowLeft size={17} weight="bold" aria-hidden="true" /> Kembali ke beranda</Link>
      </div>
    </main>
  );
}
