    ...
    <div className="bg-action text-ink-inverse">
      <div className="mx-auto flex min-h-[58vh] max-w-[1440px] items-center px-5 py-16 sm:px-8 lg:px-10">
        <div className="max-w-xl">
          <MapTrifold size={42} weight="fill" className="text-brand-highlight" aria-hidden="true" />
          <p className="mt-8 text-xs font-extrabold tracking-[0.16em] text-brand-highlight">404</p>
          ...
          <Link href="/" className="mt-8 inline-flex min-h-12 items-center gap-2 rounded-xl bg-ink-inverse px-5 text-sm font-bold text-action transition hover:-translate-y-1 hover:bg-brand-highlight active:translate-y-0"><ArrowLeft size={17} weight="bold" aria-hidden="true" /> Kembali ke beranda</Link>
        </div>
      </div>
    </div>
  );
