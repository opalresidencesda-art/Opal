...
export default async function RumahTokenPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  if (!house) notFound();
  return <main className="mx-auto max-w-[1100px] px-5 py-10 sm:px-8 lg:px-10 lg:py-16">
