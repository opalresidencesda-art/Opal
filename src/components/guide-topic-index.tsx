...
export function GuideTopicIndex({ sections }: { sections: GuideSection[] }) {
    ...
    return (
      <section aria-labelledby="guide-topic-index-title" className="mx-auto max-w-[1440px] px-5 py-12 sm:px-8 sm:py-16 lg:px-10 lg:py-20">
        <div className="max-w-2xl">
          <h2 id="guide-topic-index-title" className="public-display text-3xl font-bold leading-[1.02] text-ink sm:text-4xl">Panduan warga sedang disiapkan.</h2>
  ...
  return (
    <section aria-labelledby="guide-topic-index-title" className="mx-auto max-w-[1440px] px-5 py-12 sm:px-8 sm:py-16 lg:px-10 lg:py-20">
      <div className="max-w-2xl">
        <h2 id="guide-topic-index-title" className="public-display text-3xl font-bold leading-[1.02] text-ink sm:text-4xl">Pilih kebutuhan Anda</h2>
